      ...
      >
        <div className="containerCustom flex items-center justify-between h-full">
          ...
          <div className="flex items-center">
            ...
            <div
              className={`md:hidden  menu_icon flex flex-col items-start my-collapsible__toggle ${openMenu && "change"
                }`}
              onClick={() => {
                toggle();
                toggleMenu();
                ...
                <ul className="pt-5 ">
                  {menuList.map((menu, idx) => (
                    ...
                    >
                      <li
                        key={idx}
                        className={`py-1 px-4 block w-full capitalize rounded-lg overflow-hidden ${path === menu?.link || path === menu?.link + "/"
